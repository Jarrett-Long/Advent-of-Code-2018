...
public static class Solutions {
	...
	public static int CalculateFrequency(string[] puzzleInput)
	{
		var result = 0;
	...
	public static int? FindFirstDuplicateFrequency(string[] puzzleInput) {
		...
		while (firstDuplicate == null) {
			foreach (var input in puzzleInput) {
				currentFrequency += int.Parse(input);
